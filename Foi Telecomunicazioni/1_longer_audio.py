...
model_to_use = "turbo"
audiopath = r"F:\Whisper Model\Foi Telecomunicazioni\chunks\Mia registrazione 3.m4a"   # path of the audio file
format = "m4a"                                                                                      # format of the audio file
audio_chunks_output_dir = r"F:\Whisper Model\Foi Telecomunicazioni\chunks"                                           # the dir in which we save the audio chunks
chunk_length_ms = 10*60*1000                                                                        # the lenght we want to make the chunks of (ex 10 minutes)
chunk_export_format = "mp4"                                                                             # the format in wich we will save the chunks (RECOMMENDED TO LEAVE mp4)
chunk_export_codec = "aac"                                                                              # the encoding in wich we will save the chunks
path_in_which_to_save_transcription_file = r"F:\Whisper Model\Foi Telecomunicazioni"
